...
ggsave(plot = plot, file = "../figures/fig3_diversityAUCboxplots.png", dev = "png", width = 3, height = 4, dpi = 400)
```
...
ggsave(file = "../figures/fig3_diversityBoxplots.png", dev = "png", width = 3, height = 4, dpi = 400)
```
