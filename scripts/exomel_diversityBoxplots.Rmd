...
# Read in relabun data
taxa <- read.csv("/fs/ess/PAS1695/projects/exorien/data/drake-output/2022-03-16/2022-03-16_RA-with-taxonomy.csv") %>%   filter(sample %in% response$sample) %>%
...
# ggsave(plot = plot, file = "../figures/diversityAUCboxplots.png", dev = "png", width = 6, height = 5, dpi = 600)
```
