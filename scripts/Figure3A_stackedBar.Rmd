...
exora.p.hist$phylum <- factor(exora.p.hist$phylum, levels = c("Other", "Actinobacteria", "Apicomplexa", "Ascomycota", "Bacteroidetes", "Firmicutes", "Proteobacteria", "Uroviricota"))
...
ggsave(g, file = "../figures/fig3_stackedbar.png", dev = "png", width = 4.5, height = 4)
...
<!-- ggsave(g, file = "../figures/grantVersion_stackedbar.svg", dev = "svg", width = 4, height = 4) -->
<!-- ``` -->
