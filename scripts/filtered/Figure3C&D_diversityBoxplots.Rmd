...
ggsave(plot = plot, file = "../../figures/fig3_diversityAUCboxplots_filtered.png", dev = "png", width = 3, height = 4, dpi = 400)
```
...
ggsave(file = "../../figures/fig3_diversityBoxplots_filtered.png", dev = "png", width = 3, height = 4, dpi = 400)
```
