...
taxa <- read.csv("/fs/ess/PAS1695/projects/exorien/data/drake-output/2022-03-16/2022-03-16_unnormalized-microbes.csv")
...
```{r}
ggsave(plot = g, file = "../../figures/fig3_volcano_Htfilt.png", dev = "png", width = 4, height = 4, dpi = 600)
```
