...
save table
```{r}
write.csv(counts.ra, "../data/new_relative_abundance.csv")
write.csv(counts.ra, "/fs/ess/PAS1695/projects/exorien-melio/data/new_relative_abundance.csv")
```
...
save table
```{r}
write.csv(counts.ra.tax, "/fs/ess/PAS1695/projects/exorien-melio/data/new_relative_abundance_with_taxonomy.csv")
```
