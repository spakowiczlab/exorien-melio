---
title: "fig 5 model comparison redo"
...
Model_Comparison_Plot_RF <- ggplot(Results_RF, aes(x = forcats::fct_relevel(Model, mean_order_RF), y = AUROC, color = Model)) +
  ...
  geom_jitter() +
  labs(y = "AUROC", x = "", title = "Random Forest AUROC Model Comparison") +
...
radial_plot <- ggplot(Combined_Values_radial, aes(x = forcats::fct_relevel(`Feature Set`, svm_order), 
  ...
  geom_jitter() +
  labs(x = "", y = "AUROC", title = "Support Vector Machine Model Comparison (Radial)") +
  theme(axis.title = element_text(face = 'bold', size = '16'),
        axis.text.x = element_text(size = 10, face = 'bold'),
        plot.title = element_text(face = 'bold', hjust = 0.5, size = 14),
        axis.title.y = element_text(hjust = 0.45),
...
sigmoid_plot <- ggplot(Combined_Values_sigmoid, aes(x = forcats::fct_relevel(`Feature Set`, svm_order), 
  ...
  geom_boxplot(fatten = NULL) +
  geom_jitter() +
  labs(x = "", y = "AUROC", title = "Support Vector Machine Model Comparison (Sigmoid)") +
  theme(axis.title = element_text(face = 'bold', size = '16'),
        axis.text.x = element_text(size = 10, face = 'bold'),
        plot.title = element_text(face = 'bold', hjust = 0.5, size = 14),
        axis.title.y = element_text(hjust = 0.45),
...
save plots
```{r}
ggsave(file = "../figures/fig5_redo.png", Model_Comparison_Plot_RF, height = 6, width = 10, dpi = 400)
ggsave(file = "../figures/model_comparison_redo.png", Combined_Model_Comparison, height = 18, width = 10, dpi = 400)
```
