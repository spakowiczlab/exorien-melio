...
ggsave(Microbe_Effect_Size, filename = "../figures/Figure4-effectsize.svg", width = 6, height = 4)
```
...
heat
ggsave("../figures/Figure4-hall.pdf", dev = "pdf")
```
### IOSig 
```{r}
...
ggsave("../figures/Figure4-iosig.pdf", dev = "pdf")
```
...
ggsave("../figures/Figure4-timex.pdf", dev = "pdf")
```
